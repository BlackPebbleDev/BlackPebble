      ...
      <div className="max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <a
            ...
            aria-label="Follow Blackpebble on X"
            data-testid="link-social-x"
            className="flex items-center justify-center w-9 h-9 border border-border text-muted-foreground hover:text-foreground hover:border-accent transition-colors"
          >
            <svg
              viewBox="0 0 24 24"
              className="w-4 h-4"
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Join Blackpebble on Telegram"
