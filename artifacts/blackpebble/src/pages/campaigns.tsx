  ...
  return (
    ...
    >
      ...
      <div className="relative p-5 flex flex-col gap-3.5 flex-1">
        ...
        <div className="space-y-2">
          {c.tokenMint && <TokenContract address={c.tokenMint} stopClicks />}
          <EscrowWallet address={c.escrowAddress} stopClicks />
        </div>
                    ...
                    <div className="grid grid-cols-2 gap-x-3 gap-y-1.5 text-[11px] text-muted-foreground">
                      ...
                      <span className="col-span-2">
                        <CreatorRow
                          ...
                          trustScore={duplicate.trustScore}
                        />
                      </span>
                    </div>
                  </div>
...
export function CampaignDetailPage() {
  ...
  return (
    <div className="flex flex-col gap-6 px-4 md:px-6 py-6 sm:py-10 w-full max-w-4xl mx-auto">
      ...
      {/* Escrow clarity: token contract vs escrow wallet */}
      <div className="grid sm:grid-cols-2 gap-2.5">
        {c.tokenMint && <TokenContract address={c.tokenMint} />}
        <EscrowWallet address={c.escrowAddress} />
      </div>
