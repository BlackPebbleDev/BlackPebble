...
const SECTIONS: SafetySection[] = [
  ...
  },
  {
    ...
    points: [
      ...
      "Use a burner wallet first when testing.",
  ...
  },
  {
    ...
    points: [
      "Test new wallet tools with a burner wallet first.",
      "Keep valuable assets in a separate wallet.",
      "Start with small cleanup actions.",
